...
var weatherProvo = new XMLHttpRequest();
weatherProvo.open('GET','http://api.openweathermap.org/data/2.5/weather?zip=84057,us&appid=4b16756ef2f79712167ad71f85a69a6f&units=imperial',true);

weatherProvo.send();

weatherProvo.onload = function() {
    var weatherInfo = JSON.parse(weatherProvo.responseText);
    console.log(weatherInfo);
